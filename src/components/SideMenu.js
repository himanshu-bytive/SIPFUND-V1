        ...
        <View style={styles.container}>
            ...
            <Overlay isVisible={visibleEmandateValue ? true : false} overlayStyle={{ margin: 10, borderRadius: 10, backgroundColor: "#fff" }}>
                <View style={styles.mainbox}>
                    ...
                    <TextInput value={emandateValue} onChangeText={(val) => setEmandateValue(val)} style={styles.inputsec} placeholder="Amount" />
                    <View style={{ flexDirection: "row", alignSelf: "flex-end" }}>
                        <TouchableOpacity onPress={() => visibleEmandateValue(null)}>
                            <Text style={styles.refreshcode}>CANCEL</Text>
                        </TouchableOpacity>
                        <TouchableOpacity>
                            <Text onPress={() => handlEemandateValue()} style={styles.refreshcode}>
                                SUBMIT
                            </Text>
                        </TouchableOpacity>
                    </View>
            ...
            <ScrollView>
                ...
                <TouchableOpacity onPress={() => props.navigation.navigate("Relationship")} style={[styles.profile_sec, styles.profile]}>
                    ...
                    <View>
                        <Text style={[styles.know_text, styles.know]}>Relationship Manager</Text>
                    </View>
                </TouchableOpacity>
                ...
                <TouchableOpacity onPress={() => props.navigation.navigate("UploadDocument")} style={[styles.profile_sec, styles.profile]}>
                    ...
                    <View>
                        <Text style={[styles.know_text, styles.know]}>Upload Documents</Text>
                    </View>
                </TouchableOpacity>
