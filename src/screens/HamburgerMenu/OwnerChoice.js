                    ...
                    <View style={styles.axis_asset}>
                        ...
                        <View style={styles.value_sec}>
                            <View style={styles.mininvestment}>
                                ...
                                <Text style={styles.min}>{choices[0]?.nseProductDetail.minimumSIPAmount > 1000 ? 1000 : choices[0]?.nseProductDetail.minimumSIPAmount}</Text>
                            </View>
                            <View style={styles.mininvestment}>
                                <Text style={styles.min}>AUM</Text>
                                <Text style={styles.min}>{choices[0]?.api["PSRP-TotalMarketValueNet"]}</Text>
                            </View>
                            <View style={styles.mininvestment}>
                                <Text style={styles.min}>Returns</Text>
                                <Text style={styles.min}>{choices[0]?.nseProductDetail.productCurrentNavValue}</Text>
                            </View>
                        </View>
                        <View
                            style={{
