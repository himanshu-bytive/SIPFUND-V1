...
const mapDispatchToProps = (stateProps, dispatchProps, ownProps) => {
    ...
    return {
        ...stateProps,
        ...ownProps,
        goalSummary: (params, token) => { GoalsActions.goalSummary(dispatch, params, token) },
    }
}
export default connect(mapStateToProps, undefined, mapDispatchToProps)(GoalsSummaryScreen)