    ...
    return (
        <View style={styles.container}>
            ...
            <ScrollView>
                ...
                <View style={styles.invest_sec}>
                    <View style={styles.invest}>
                        ...
                        <View style={styles.investright}>
                            <Text style={styles.text_goals}>You’re Almost
                                Ready To Invest</Text>
                        </View>
                    </View>
                ...
                <Text style={styles.know}>SIPFund.com brings 5 things you must know</Text>
...
export default connect(mapStateToProps, undefined, mapDispatchToProps)(CompleteDetailScreen)